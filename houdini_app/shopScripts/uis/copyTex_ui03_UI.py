...
# Form implementation generated from reading ui file 'X:\app\win\Pipeline\houdini_app\shopScripts\uis\copyTex_ui03.ui'
#
# Created: Mon Jul 20 17:25:09 2020
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ckbTx = QCheckBox(Dialog)
        self.ckbTx.setChecked(True)
        self.ckbTx.setObjectName("ckbTx")
        self.horizontalLayout.addWidget(self.ckbTx)
        self.ckbNonTx = QCheckBox(Dialog)
        self.ckbNonTx.setChecked(True)
        self.ckbNonTx.setObjectName("ckbNonTx")
        self.horizontalLayout.addWidget(self.ckbNonTx)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ckbTx.setText(".tx files")
        self.ckbNonTx.setText("Non .tx files (.exrs, .pngs, .tifs etc)")
