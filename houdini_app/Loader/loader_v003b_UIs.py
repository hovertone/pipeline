...
"}")
        ...
        # self.pb_next = QPushButton(FileManager)
        # self.pb_next.setMaximumSize(QSize(23, 21))
...
"}")
        ...
        self.cbox_project = QListWidget(self.frame_left)
        ...
        self.cbox_sequence = QListWidget(self.frame_left)
        ...
        self.cbox_type = QListWidget(self.frame_left)
