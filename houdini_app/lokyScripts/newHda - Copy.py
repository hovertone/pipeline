...
def newHda(pipeLinePath="X:/app/win/Pipeline"):
	...
	definition = node.createDigitalAsset(name=assetName, hda_file_name=filePath, description=assetName, min_num_inputs=0, max_num_inputs=1, compress_contents=False, comment=None, version=None, save_as_embedded=False, ignore_external_references=False, change_node_type=True, create_backup=True)
	node = hou.selectedNodes()[0]
