...
def main():
    ...
    path1 = '//vpstorage.plarium.local/vpd/raid/assets/characters/order_knight'
    ...
    for i, tc in enumerate(toCopy):
        ...
        destPath = tc.replace('//vpstorage.plarium.local/vpd/raid/assets/characters/order_knight', 'P:/Raid/in/200715/elven_female_textures')
        try:
