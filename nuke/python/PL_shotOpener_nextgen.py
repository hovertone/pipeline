...
class userPick(QtGuiWidgets.QWidget):
    def __init__(self, names):
        super(userPick, self).__init__()
        nuke.tprint('asfasdf')
        ...
        self.resave = QtGuiWidgets.QCheckBox("Resave script")
        self.masterLayout.addWidget(self.resave)

        #self.installEventFilter(self)
        nuke.tprint('ggggg')

        #self.pybutton = QtGuiWidgets.QPushButton('Create a button', self)
        #self.masterLayout.addWidget(self.pybutton)
