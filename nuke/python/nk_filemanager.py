...
class NukeManager(Filemanager):
    ...
    def setup_scene(self):
        ...
        nuke.tprint(self.listWidget_files.currentItem())
        if self.listWidget_files.itemWidget(self.listWidget_files.currentItem()) and self.listWidget_files.itemWidget(self.listWidget_files.currentItem()).type == 'folder':
