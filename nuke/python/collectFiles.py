...
import time
import webbrowser
from LH import findGizmos
from LH import convertGizmosToGroups
        ...
        for fileNode in nuke.allNodes():
            ...
            if checkForKnob(fileNode, 'file'):
                if not checkForKnob(fileNode, 'Render'):
                    if '[netw' in fileNode['file'].value():
                        fileNodePath = fileNode['netw'].value()
                    else:
                    ...
                    if (fileNodePath == ''):
                        ...
                        folderReadFilename = fileNodePath.split("/")[-2]
                        ...
                        if checkForKnob(fileNode, 'first'):
                            ...
                            if (fileNodePath.endswith(tuple(videoExtension))):
                                ...
                                if (os.path.exists(footagePath + folderReadFilename + '/')):
                                    pass
                                else:
                                    os.mkdir(footagePath + folderReadFilename + '/')
                                ...
                                if (frameFirst == frameLast):
                                    ...
                                    newFilenamePath = footagePath + folderReadFilename + '/' + readFilename
                                    if (os.path.exists(newFilenamePath)):
                                        print (newFilenamePath + '     DUPLICATED')
                                    else:
                                        if (os.path.exists(fileNodePath)):
                        ...
                        # Copy single file
                            ...
                            newFilenamePath = footagePath + folderReadFilename + '/' + fileNodePath.split("/")[-1]
                            if (os.path.exists(newFilenamePath)):
                                print (newFilenamePath + '     DUPLICATED')
                            else:
                                if (os.path.exists(fileNodePath)):
                        ...
                        if (fileNodePath == ''):
                            ...
                            if checkForKnob(fileNode, 'first'):                            
                                if (fileNodePath.endswith(tuple(videoExtension))):
                                    ...
                                    folderReadFilename = fileNodePath.split("/")[-2]
                                    readFilename = fileNodePath.split("/")[-1]
                                    reloadPath = '[file dirname [value root.name]]/footage/' + folderReadFilename + '/' + readFilename
