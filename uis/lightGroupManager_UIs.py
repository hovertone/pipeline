...
#
# Created: Fri Aug 10 15:00:14 2018
...
class Ui_LightGroupManager(object):
    ...
    def retranslateUi(self, LightGroupManager):
        LightGroupManager.setWindowTitle(QApplication.translate("LightGroupManager", "Light Group Manager", None, QApplication.UnicodeUTF8))
        self.lb_lights.setText(QApplication.translate("LightGroupManager", "Lights", None, QApplication.UnicodeUTF8))
        self.pb_insert_aov.setText(QApplication.translate("LightGroupManager", ">>", None, QApplication.UnicodeUTF8))
        self.pb_remove_aov.setText(QApplication.translate("LightGroupManager", "<<", None, QApplication.UnicodeUTF8))
        self.lb_aovs.setText(QApplication.translate("LightGroupManager", "AOVs", None, QApplication.UnicodeUTF8))
        self.pb_refresh.setText(QApplication.translate("LightGroupManager", "Refresh", None, QApplication.UnicodeUTF8))
        self.pb_apply.setText(QApplication.translate("LightGroupManager", "Apply", None, QApplication.UnicodeUTF8))
