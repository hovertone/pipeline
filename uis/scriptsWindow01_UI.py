...
# Form implementation generated from reading ui file 'X:\app\win\Pipeline\uis222\scriptsWindow01.ui'
#
# Created: Wed Oct 31 15:58:47 2018
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget = QtGui.QWidget(self.viewerGroup)
        self.widget.setGeometry(QtCore.QRect(10, 20, 161, 83))
        self.widget.setObjectName("widget")
        self.viewerLayout = QtGui.QVBoxLayout(self.widget)
        self.viewerLayout.setContentsMargins(0, 0, 0, 0)
        self.viewerLayout.setObjectName("viewerLayout")
        self.flopflop = QtGui.QPushButton(self.widget)
        self.flopflop.setObjectName("flopflop")
        self.viewerLayout.addWidget(self.flopflop)
        self.autocrop = QtGui.QPushButton(self.widget)
        self.autocrop.setObjectName("autocrop")
        self.viewerLayout.addWidget(self.autocrop)
        self.viewerToRGBA = QtGui.QPushButton(self.widget)
        ...
        self.widget2 = QtGui.QWidget(self.writeGroup)
        self.widget2.setGeometry(QtCore.QRect(10, 20, 161, 54))
        self.widget2.setObjectName("widget2")
        self.writeLayout = QtGui.QVBoxLayout(self.widget2)
        self.writeLayout.setContentsMargins(0, 0, 0, 0)
        self.writeLayout.setObjectName("writeLayout")
        self.deleteWriteFiles = QtGui.QPushButton(self.widget2)
        self.deleteWriteFiles.setObjectName("deleteWriteFiles")
        self.writeLayout.addWidget(self.deleteWriteFiles)
        self.rerenderMissingFrames = QtGui.QPushButton(self.widget2)
