...
# Form implementation generated from reading ui file 'X:\app\win\Pipeline\uis222\scriptsWindow03.ui'
#
# Created: Wed May 22 17:50:10 2019
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.toosetLoaderCreate = QtGui.QPushButton(self.widget)
        self.toosetLoaderCreate.setObjectName("toosetLoaderCreate")
        self.verticalLayout.addWidget(self.toosetLoaderCreate)
        self.toosetLoader = QtGui.QPushButton(self.widget)
        self.toosetLoader.setObjectName("toosetLoader")
        self.verticalLayout.addWidget(self.toosetLoader)
...
"nuke.toNode(v)[\'channels\'].setValue(\'rgba\')", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.toosetLoaderCreate.setToolTip(QtGui.QApplication.translate("Form", "<html><head/><body><p>Выставляет выделенные ноды <span style=\" font-weight:600;\">горизонтально</span>.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoaderCreate.setText(QtGui.QApplication.translate("Form", "Toolset Create", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoaderCreate.setProperty("script", QtGui.QApplication.translate("Form", "import toolsets_loader\nreload(toolsets_loader)\ntlc = toolsets_loader.toolsetCreate()\ntlc.show()", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoaderCreate.setProperty("name", QtGui.QApplication.translate("Form", "toolsetLoaderCreate", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoaderCreate.setProperty("gifname", QtGui.QApplication.translate("Form", "giphy", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoader.setToolTip(QtGui.QApplication.translate("Form", "<html><head/><body><p>Выставляет выделенные ноды <span style=\" font-weight:600;\">горизонтально</span>.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoader.setText(QtGui.QApplication.translate("Form", "Toolset Loader", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoader.setProperty("script", QtGui.QApplication.translate("Form", "scripts.lineupNodes()", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoader.setProperty("name", QtGui.QApplication.translate("Form", "lineupHorizontally", None, QtGui.QApplication.UnicodeUTF8))
        self.toosetLoader.setProperty("gifname", QtGui.QApplication.translate("Form", "giphy", None, QtGui.QApplication.UnicodeUTF8))
